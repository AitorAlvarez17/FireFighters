...
namespace UnityEngine.PostProcessing
{
    ...
    public class EyeAdaptationModel : PostProcessingModel
    {
        ...
        public struct Settings
        {
            ...
            [MiniA(0f), Tooltip("Exposure bias. Use this to offset the global exposure of the scene.")]
            ...
            [MiniA(0f), Tooltip("Adaptation speed from a dark to a light environment.")]
            public float speedUp;

            [MiniA(0f), Tooltip("Adaptation speed from a light to a dark environment.")]
