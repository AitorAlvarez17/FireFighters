...
namespace UnityEngine.PostProcessing
{
    ...
    public class BloomModel : PostProcessingModel
    {
        ...
        {
            [MiniA(0f), Tooltip("Strength of the bloom filter.")]
            public float intensity;

            [MiniA(0f), Tooltip("Filters out pixels under this level of brightness.")]
        ...
        public struct LensDirtSettings
        {
            ...
            [MiniA(0f), Tooltip("Amount of lens dirtiness.")]
            public float intensity;
